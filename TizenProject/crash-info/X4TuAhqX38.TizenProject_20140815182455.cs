...
PID: 7324
Date: 2014-08-15 18:24:55(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 7324, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000032
r2   = 0x0000001e, r3   = 0x0000ffff
r4   = 0xb3d58d70, r5   = 0xbeebcf50
r6   = 0x00000000, r7   = 0xbeebcf30
r8   = 0x000002d0, r9   = 0x00000000
r10  = 0xb263da58, fp   = 0xbeebcfe0
ip   = 0xb3768eb1, sp   = 0xbeebcc68
lr   = 0xb3768ed5, pc   = 0xb389e0cc
cpsr = 0x88000030
...
000dc000 0089a000 rw-p [heap]
ac6cc000 ac6d1000 r-xp /usr/lib/libhaptic-module.so
...
b2602000 b266d000 r-xp /opt/usr/apps/X4TuAhqX38/bin/TizenProject.exe
...
Callstack Information (PID:7324)
Call Stack Count: 33
 0: (0xb389e0cc) [/usr/lib/osp/libosp-uifw.so] + 0x4a80cc
 1: Tizen::Ui::Controls::Label::Construct(Tizen::Graphics::Rectangle const&, Tizen::Base::String const&) + 0x24 (0xb3768ed5) [/usr/lib/osp/libosp-uifw.so] + 0x372ed5
 2: PartnerItem::OnDraw(Tizen::Graphics::Canvas&, Tizen::Graphics::Rectangle const&, Tizen::Ui::Controls::ListItemDrawingStatus) + 0x2bc (0xb263dd14) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x3bd14
End of Call Stack
