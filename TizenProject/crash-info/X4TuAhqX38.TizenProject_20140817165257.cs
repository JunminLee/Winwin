...
PID: 2010
Date: 2014-08-17 16:52:57(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 2010, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x000007da
r2   = 0x00000006, r3   = 0x000007da
r4   = 0x00000006, r5   = 0xb6c96be4
r6   = 0xb6c96000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x000d3588
r10  = 0xb6aa7000, fp   = 0xbed297c0
ip   = 0xb6aa74c0, sp   = 0xbed29028
lr   = 0xb6b9d55c, pc   = 0xb6b99760
cpsr = 0x28000010
...
000dc000 00e98000 rw-p [heap]
aa9ea000 aa9ef000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
aec44000 aec46000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
afa2d000 afa3e000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
afa47000 afa4c000 r-xp /usr/lib/libhaptic-module.so
b1d0e000 b1d59000 r-xp /usr/lib/libGLESv1_CM.so.1.1
b1d62000 b1d6c000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b1d74000 b1d9c000 r-xp /usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so
b1dc4000 b1dd0000 r-xp /usr/lib/libtzsvc.so.0.0.1
b1ddd000 b1e03000 r-xp /usr/lib/libzmq.so.3.0.0
b1e0d000 b1e16000 r-xp /usr/lib/libpims-ipc.so.0.0.30
b1e1e000 b1e20000 r-xp /usr/lib/libemail-network.so.1.1.0
b1e28000 b1e41000 r-xp /usr/lib/libaccounts-svc.so.0.2.66
b1e49000 b1ef3000 r-xp /usr/lib/libuw-imap-toolkit.so.0.0.0
b1f01000 b1f05000 r-xp /usr/lib/libss-client.so.1.0.0
b1f0d000 b1f0f000 r-xp /usr/lib/libcamsrcjpegenc.so.0.0.0
b1f17000 b1f20000 r-xp /usr/lib/libmsg_vobject.so
b1f29000 b1f33000 r-xp /usr/lib/libdrm-client.so.0.0.1
b1f3b000 b1fad000 r-xp /usr/lib/libcontacts-service2.so.0.9.114.7
b1fcc000 b1fe5000 r-xp /usr/lib/libmsg_plugin_manager.so
b1fee000 b2027000 r-xp /usr/lib/libmsg_framework_handler.so
b2030000 b2064000 r-xp /usr/lib/libmsg_transaction_proxy.so
b206d000 b20ad000 r-xp /usr/lib/libmsg_utils.so
b20ae000 b20bd000 r-xp /usr/lib/libemail-common-use.so.1.1.0
b20c6000 b2141000 r-xp /usr/lib/libemail-core.so.1.1.0
b2151000 b219a000 r-xp /usr/lib/libemail-storage.so.1.1.0
b21a3000 b21b0000 r-xp /usr/lib/libemail-ipc.so.1.1.0
b21b8000 b21be000 r-xp /usr/lib/libshortcut.so.0.0.1
b21c7000 b21cd000 r-xp /usr/lib/libbadge.so.0.0.1
b21d5000 b21db000 r-xp /usr/lib/libcapi-appfw-app-manager.so.0.1.0
b21e3000 b21f5000 r-xp /usr/lib/libmmfile_utils.so.0.0.0
b21fd000 b2202000 r-xp /usr/lib/libmmffile.so.0.0.0
b220a000 b226e000 r-xp /usr/lib/libmmfcamcorder.so.0.0.0
b227b000 b228f000 r-xp /usr/lib/libnetwork.so.0.0.0
b2298000 b22a0000 r-xp /usr/lib/libpush.so.0.2.12
b22a8000 b22c3000 r-xp /usr/lib/libmsg_mapi.so.0.1.0
b22cc000 b22e4000 r-xp /usr/lib/libemail-api.so.1.1.0
b22ec000 b230a000 r-xp /usr/lib/osp/libosp-shell-core.so.1.2.2.1
b2313000 b232d000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b2337000 b233c000 r-xp /usr/lib/libcapi-media-metadata-extractor.so
b2344000 b2349000 r-xp /usr/lib/libcapi-media-recorder.so.0.1.3
b2351000 b235c000 r-xp /usr/lib/libcapi-media-camera.so.0.1.4
b2364000 b2367000 r-xp /usr/lib/libcapi-media-sound-manager.so.0.1.1
b236f000 b237d000 r-xp /usr/lib/libcapi-media-player.so.0.1.1
b2385000 b23a6000 r-xp /usr/lib/libopencore-amrnb.so.0.0.2
b23af000 b23b3000 r-xp /usr/lib/libogg.so.0.7.1
b23bb000 b23dd000 r-xp /usr/lib/libvorbis.so.0.4.3
b23e5000 b23e9000 r-xp /usr/lib/libcapi-media-audio-io.so.0.2.0
b23f1000 b2405000 r-xp /usr/lib/libwifi-direct.so.0.0
b240d000 b2415000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b2416000 b241f000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b2427000 b2474000 r-xp /usr/lib/osp/libosp-messaging.so.1.2.2.0
b247e000 b2574000 r-xp /usr/lib/osp/libosp-media.so.1.2.2.0
b2587000 b264c000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b265a000 b2677000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b2680000 b2683000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b2692000 b2708000 r-xp /opt/usr/apps/X4TuAhqX38/bin/TizenProject.exe
...
b4189000 b418b000 r-xp /opt/usr/apps/X4TuAhqX38/bin/TizenProject
...
Callstack Information (PID:2010)
Call Stack Count: 47
 0: gsignal + 0x3c (0xb6b99760) [/lib/libc.so.6] + 0x2a760
 1: abort + 0x1ac (0xb6b9d55c) [/lib/libc.so.6] + 0x2e55c
 2: __assert_fail + 0x10c (0xb6b9263c) [/lib/libc.so.6] + 0x2363c
 3: SysAssertfInternal + 0x82 (0xb42eecef) [/usr/lib/osp/libosp-appfw.so] + 0x132cef
 4: Tizen::Net::Http::HttpSession::OpenTransactionN() + 0x68 (0xb25cc4dd) [/usr/lib/osp/libosp-net.so.1] + 0x454dd
 5: Chatting::RequestHttpPost() + 0xd0 (0xb26a94e8) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x174e8
 6: Chatting::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x14c (0xb26aa120) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x18120
 7: non-virtual thunk to Chatting::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb26ab168) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x19168
End of Call Stack
