...
PID: 30024
Date: 2014-08-14 10:41:41(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 30024, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00007548
r2   = 0x00000006, r3   = 0x00007548
r4   = 0x00000006, r5   = 0xb6bfbbe4
r6   = 0xb6bfb000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x000d6ab0
r10  = 0xb6a0c000, fp   = 0xbeebc810
ip   = 0xb6a0c4c0, sp   = 0xbeebc100
lr   = 0xb6b0255c, pc   = 0xb6afe760
cpsr = 0x28000010
...
000dc000 00a13000 rw-p [heap]
af9c9000 af9cb000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af9d3000 af9e4000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
af9ed000 af9f2000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
af9fa000 af9ff000 r-xp /usr/lib/libhaptic-module.so
b1c81000 b1ccc000 r-xp /usr/lib/libGLESv1_CM.so.1.1
b1cd5000 b1cdf000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b1ce7000 b1d0f000 r-xp /usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so
b1d37000 b1d43000 r-xp /usr/lib/libtzsvc.so.0.0.1
b1d50000 b1d76000 r-xp /usr/lib/libzmq.so.3.0.0
b1d80000 b1d89000 r-xp /usr/lib/libpims-ipc.so.0.0.30
b1d91000 b1d93000 r-xp /usr/lib/libemail-network.so.1.1.0
b1d9b000 b1db4000 r-xp /usr/lib/libaccounts-svc.so.0.2.66
b1dbc000 b1e66000 r-xp /usr/lib/libuw-imap-toolkit.so.0.0.0
b1e74000 b1e78000 r-xp /usr/lib/libss-client.so.1.0.0
b1e80000 b1e82000 r-xp /usr/lib/libcamsrcjpegenc.so.0.0.0
b1e8a000 b1e93000 r-xp /usr/lib/libmsg_vobject.so
b1e9c000 b1ea6000 r-xp /usr/lib/libdrm-client.so.0.0.1
b1eae000 b1f20000 r-xp /usr/lib/libcontacts-service2.so.0.9.114.7
b1f3f000 b1f58000 r-xp /usr/lib/libmsg_plugin_manager.so
b1f61000 b1f9a000 r-xp /usr/lib/libmsg_framework_handler.so
b1fa3000 b1fd7000 r-xp /usr/lib/libmsg_transaction_proxy.so
b1fe0000 b2020000 r-xp /usr/lib/libmsg_utils.so
b2021000 b2030000 r-xp /usr/lib/libemail-common-use.so.1.1.0
b2039000 b20b4000 r-xp /usr/lib/libemail-core.so.1.1.0
b20c4000 b210d000 r-xp /usr/lib/libemail-storage.so.1.1.0
b2116000 b2123000 r-xp /usr/lib/libemail-ipc.so.1.1.0
b212b000 b2131000 r-xp /usr/lib/libshortcut.so.0.0.1
b213a000 b2140000 r-xp /usr/lib/libbadge.so.0.0.1
b2148000 b214e000 r-xp /usr/lib/libcapi-appfw-app-manager.so.0.1.0
b2156000 b2168000 r-xp /usr/lib/libmmfile_utils.so.0.0.0
b2170000 b2175000 r-xp /usr/lib/libmmffile.so.0.0.0
b217d000 b21e1000 r-xp /usr/lib/libmmfcamcorder.so.0.0.0
b21ee000 b2202000 r-xp /usr/lib/libnetwork.so.0.0.0
b220b000 b2213000 r-xp /usr/lib/libpush.so.0.2.12
b221b000 b2236000 r-xp /usr/lib/libmsg_mapi.so.0.1.0
b223f000 b2257000 r-xp /usr/lib/libemail-api.so.1.1.0
b225f000 b227d000 r-xp /usr/lib/osp/libosp-shell-core.so.1.2.2.1
b2286000 b22a0000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b22aa000 b22af000 r-xp /usr/lib/libcapi-media-metadata-extractor.so
b22b7000 b22bc000 r-xp /usr/lib/libcapi-media-recorder.so.0.1.3
b22c4000 b22cf000 r-xp /usr/lib/libcapi-media-camera.so.0.1.4
b22d7000 b22da000 r-xp /usr/lib/libcapi-media-sound-manager.so.0.1.1
b22e2000 b22f0000 r-xp /usr/lib/libcapi-media-player.so.0.1.1
b22f8000 b2319000 r-xp /usr/lib/libopencore-amrnb.so.0.0.2
b2322000 b2326000 r-xp /usr/lib/libogg.so.0.7.1
b232e000 b2350000 r-xp /usr/lib/libvorbis.so.0.4.3
b2358000 b235c000 r-xp /usr/lib/libcapi-media-audio-io.so.0.2.0
b2364000 b2378000 r-xp /usr/lib/libwifi-direct.so.0.0
b2380000 b2388000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b2389000 b2392000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b239a000 b23e7000 r-xp /usr/lib/osp/libosp-messaging.so.1.2.2.0
b23f1000 b24e7000 r-xp /usr/lib/osp/libosp-media.so.1.2.2.0
b24fa000 b25bf000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b25cd000 b25ea000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b25f3000 b25f6000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b2605000 b266e000 r-xp /opt/usr/apps/X4TuAhqX38/bin/TizenProject.exe
...
Callstack Information (PID:30024)
Call Stack Count: 47
 0: gsignal + 0x3c (0xb6afe760) [/lib/libc.so.6] + 0x2a760
 1: abort + 0x1ac (0xb6b0255c) [/lib/libc.so.6] + 0x2e55c
 2: __assert_fail + 0x10c (0xb6af763c) [/lib/libc.so.6] + 0x2363c
 3: SysAssertfInternal + 0x82 (0xb4253cef) [/usr/lib/osp/libosp-appfw.so] + 0x132cef
 4: Tizen::Net::Http::HttpSession::OpenTransactionN() + 0x68 (0xb253f4dd) [/usr/lib/osp/libosp-net.so.1] + 0x454dd
 5: Chatting::RequestHttpPost() + 0xd0 (0xb261b1f4) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x161f4
 6: Chatting::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x14c (0xb261bd44) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x16d44
 7: non-virtual thunk to Chatting::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb261cc38) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x17c38
End of Call Stack
