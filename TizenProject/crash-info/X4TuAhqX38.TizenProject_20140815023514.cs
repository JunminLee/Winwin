...
PID: 23342
Date: 2014-08-15 02:35:14(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 23342, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00005b2e
r2   = 0x00000006, r3   = 0x00005b2e
r4   = 0x00000006, r5   = 0xb6bfbbe4
r6   = 0xb6bfb000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x000d8278
r10  = 0xb6a0c000, fp   = 0xbeebc810
ip   = 0xb6a0c4c0, sp   = 0xbeebc078
...
000dc000 00fa2000 rw-p [heap]
a8979000 a897b000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
aaac8000 aaacd000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
ac3d0000 ac3e1000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
ac590000 ac595000 r-xp /usr/lib/libhaptic-module.so
...
Callstack Information (PID:23342)
Call Stack Count: 47
 ...
 4: Tizen::Net::Http::HttpSession::OpenTransactionN() + 0x68 (0xb253e4dd) [/usr/lib/osp/libosp-net.so.1] + 0x454dd
 5: Chatting::RequestHttpPost() + 0xd0 (0xb261a390) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x16390
 6: Chatting::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x14c (0xb261afc8) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x16fc8
 7: non-virtual thunk to Chatting::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb261bed0) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x17ed0
End of Call Stack
