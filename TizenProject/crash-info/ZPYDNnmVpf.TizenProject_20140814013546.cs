...
PID: 24575
Date: 2014-08-14 01:35:46(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 24575, uid 5000)

Register Information
r0   = 0x0003e168, r1   = 0x00000000
r2   = 0x00000000, r3   = 0x00000037
r4   = 0x0033db5e, r5   = 0x00b91708
r6   = 0x00000000, r7   = 0xbedb5f58
r8   = 0x00445028, r9   = 0x000000f6
r10  = 0x000000ef, fp   = 0xbedb6008
ip   = 0xb69f3b98, sp   = 0xbedb5d90
lr   = 0xb4237583, pc   = 0xb3a0220c
cpsr = 0x48000030
...
000dc000 00bd1000 rw-p [heap]
aeeda000 aeedf000 r-xp /usr/lib/libhaptic-module.so
b0baf000 b0bb2000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b23fa000 b2445000 r-xp /usr/lib/libGLESv1_CM.so.1.1
b244e000 b2476000 r-xp /usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so
...
b25c4000 b25e1000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b25ea000 b25f4000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b25fc000 b2655000 r-xp /opt/usr/apps/ZPYDNnmVpf/bin/TizenProject.exe
...
Callstack Information (PID:24575)
Call Stack Count: 30
 0: Tizen::Graphics::Canvas::DrawText(Tizen::Graphics::Point const&, Tizen::Graphics::EnrichedText const&) + 0xf (0xb3a0220c) [/usr/lib/osp/libosp-uifw.so] + 0x62520c
 1: ChattingListItem::OnDraw() + 0x2e0 (0xb2612b88) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x16b88
 2: Tizen::Ui::_ContainerImpl::OnDraw() + 0x28 (0xb36ad86d) [/usr/lib/osp/libosp-uifw.so] + 0x2d086d
 3: Tizen::Ui::_Control::ControlVisualElementContentProvider::PrepareDraw(Tizen::Ui::Animations::VisualElement&) + 0xb6 (0xb369cd0f) [/usr/lib/osp/libosp-uifw.so] + 0x2bfd0f
 4: Tizen::Ui::Animations::_VisualElementImpl::InvokePrepareDraw() + 0x16 (0xb362515b) [/usr/lib/osp/libosp-uifw.so] + 0x24815b
 5: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangle(Tizen::Graphics::FloatRectangle const&) + 0x2d4 (0xb362546d) [/usr/lib/osp/libosp-uifw.so] + 0x24846d
 6: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangleIfNeeded(Tizen::Graphics::FloatRectangle const&) + 0x70 (0xb36255c5) [/usr/lib/osp/libosp-uifw.so] + 0x2485c5
 7: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangleIfNeeded(Tizen::Graphics::FloatRectangle const&) + 0x112 (0xb3625667) [/usr/lib/osp/libosp-uifw.so] + 0x248667
 8: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangleIfNeeded(Tizen::Graphics::FloatRectangle const&) + 0x112 (0xb3625667) [/usr/lib/osp/libosp-uifw.so] + 0x248667
 9: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangleIfNeeded(Tizen::Graphics::FloatRectangle const&) + 0x112 (0xb3625667) [/usr/lib/osp/libosp-uifw.so] + 0x248667
10: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangleIfNeeded(Tizen::Graphics::FloatRectangle const&) + 0x112 (0xb3625667) [/usr/lib/osp/libosp-uifw.so] + 0x248667
11: Tizen::Ui::Animations::_VisualElementImpl::DrawRectangleIfNeeded(Tizen::Graphics::FloatRectangle const&) + 0x112 (0xb3625667) [/usr/lib/osp/libosp-uifw.so] + 0x248667
12: Tizen::Ui::Animations::_VisualElementImpl::Draw() + 0x9e (0xb362578b) [/usr/lib/osp/libosp-uifw.so] + 0x24878b
13: Tizen::Ui::Animations::_DisplayManager::Render(Tizen::Ui::Animations::_RootVisualElement&) + 0x30 (0xb360f911) [/usr/lib/osp/libosp-uifw.so] + 0x232911
14: Tizen::Ui::Animations::_DisplayManager::RenderAll() + 0x36 (0xb360f9bf) [/usr/lib/osp/libosp-uifw.so] + 0x2329bf
End of Call Stack
