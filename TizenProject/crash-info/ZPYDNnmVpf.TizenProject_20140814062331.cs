...
PID: 14521
Date: 2014-08-14 06:23:31(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 14521, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000000
r2   = 0x00000308, r3   = 0x0072a900
r4   = 0xb260de8c, r5   = 0x0072a908
r6   = 0x00000000, r7   = 0x00000308
r8   = 0xbedb5d80, r9   = 0x000d1000
r10  = 0xb4424940, fp   = 0xbedb5c68
ip   = 0xb3d41da0, sp   = 0xbedb5b90
lr   = 0xb3684b5b, pc   = 0xb36a1bdc
cpsr = 0x88000030
...
000cc000 00bb9000 rw-p [heap]
ab0c2000 ab0c7000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
...
Callstack Information (PID:14521)
Call Stack Count: 43
 0: Tizen::Ui::_ControlImpl::GetFullScreenSizeInfo() + 0x53 (0xb36a1bdc) [/usr/lib/osp/libosp-uifw.so] + 0x2c4bdc
 1: Tizen::Ui::Control::SetPosition(int, int) + 0xe (0xb3684b5b) [/usr/lib/osp/libosp-uifw.so] + 0x2a7b5b
 2: Chatting::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x214 (0xb260da9c) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x12a9c
 3: non-virtual thunk to Chatting::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb260dec8) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x12ec8
End of Call Stack
