...
PID: 5871
Date: 2014-08-15 02:39:46(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 5871, uid 5000)
...
Call Stack Count: 32
 ...
 1: JMChattControl::GetImageIndexByPoint(Tizen::Graphics::Point) + 0xa8 (0xb263daf4) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39af4
 2: JMChattControl::OnTouchPressed(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0xf8 (0xb263d9dc) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x399dc
 3: non-virtual thunk to JMChattControl::OnTouchPressed(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0x4c (0xb263dc70) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39c70
