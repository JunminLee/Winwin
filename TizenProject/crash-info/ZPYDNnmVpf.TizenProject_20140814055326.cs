...
PID: 10477
Date: 2014-08-14 05:53:26(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 10477, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000000
r2   = 0x83fd9a00, r3   = 0xb4424940
r4   = 0xb2619bb8, r5   = 0x006ff88c
r6   = 0x00875960, r7   = 0x00877ad8
r8   = 0xbedb5d80, r9   = 0x000d0d48
r10  = 0xb4424940, fp   = 0xbedb5c68
ip   = 0xb26603bc, sp   = 0xbedb56d8
lr   = 0xb26182d4, pc   = 0xb4238534
cpsr = 0x68000030
...
000cc000 00b4b000 rw-p [heap]
ab84c000 ab84e000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
ad67b000 ad680000 r-xp /usr/lib/libhaptic-module.so
b014b000 b015c000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b0165000 b016a000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b0ba6000 b0ba9000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b23f1000 b243c000 r-xp /usr/lib/libGLESv1_CM.so.1.1
b2445000 b246d000 r-xp /usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so
b2495000 b24a9000 r-xp /usr/lib/libnetwork.so.0.0.0
b24b2000 b24c6000 r-xp /usr/lib/libwifi-direct.so.0.0
b24ce000 b24d6000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b24d7000 b24e0000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b24e8000 b25ad000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b25bb000 b25d8000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b25e1000 b25eb000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b25f3000 b2655000 r-xp /opt/usr/apps/ZPYDNnmVpf/bin/TizenProject.exe
...
Callstack Information (PID:10477)
Call Stack Count: 42
 0: Tizen::Base::String::GetLength() const + 0x3 (0xb4238534) [/usr/lib/osp/libosp-appfw.so] + 0x130534
 1: Editing::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x1334 (0xb26182d4) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x252d4
 2: non-virtual thunk to Editing::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb2619bf4) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x26bf4
End of Call Stack
