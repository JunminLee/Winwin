...
PID: 13493
Date: 2014-08-14 06:18:19(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 13493, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0xbedb5558
r2   = 0x000000ff, r3   = 0x000000ff
r4   = 0xa9e0eb88, r5   = 0xb3d3fd70
r6   = 0xbedb5558, r7   = 0xb3d3fd70
r8   = 0xa00009cb, r9   = 0xbedb56ec
r10  = 0x00000001, fp   = 0xbedb55c0
ip   = 0xb3d41da0, sp   = 0xbedb5380
lr   = 0xb3889657, pc   = 0xb36a1bdc
cpsr = 0x08000030
...
00018000 000cc000 rw-p [heap]
000cc000 00a82000 rw-p [heap]
aeed9000 aeede000 r-xp /usr/lib/libhaptic-module.so
b0105000 b0116000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b011f000 b0124000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b0bae000 b0bb1000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b23f9000 b2444000 r-xp /usr/lib/libGLESv1_CM.so.1.1
b244d000 b2475000 r-xp /usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so
b249d000 b24b1000 r-xp /usr/lib/libnetwork.so.0.0.0
b24ba000 b24ce000 r-xp /usr/lib/libwifi-direct.so.0.0
b24d6000 b24de000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b24df000 b24e8000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b24f0000 b25b5000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b25c3000 b25e0000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b25e9000 b25f3000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b25fb000 b2655000 r-xp /opt/usr/apps/ZPYDNnmVpf/bin/TizenProject.exe
...
Callstack Information (PID:13493)
Call Stack Count: 46
 0: Tizen::Ui::_ControlImpl::GetFullScreenSizeInfo() + 0x53 (0xb36a1bdc) [/usr/lib/osp/libosp-uifw.so] + 0x2c4bdc
 1: (0xb3889657) [/usr/lib/osp/libosp-uifw.so] + 0x4ac657
 2: Tizen::Ui::Controls::Panel::SetBackgroundColor(Tizen::Graphics::Color const&) + 0xa (0xb3756cd7) [/usr/lib/osp/libosp-uifw.so] + 0x379cd7
 3: Chatting::OnInitializing() + 0x134 (0xb260c890) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x11890
 4: Tizen::Ui::_ControlImpl::OnAttachedToMainTree() + 0x22 (0xb36a11a3) [/usr/lib/osp/libosp-uifw.so] + 0x2c41a3
 5: Tizen::Ui::Controls::_FormImpl::OnAttachedToMainTree() + 0x2e (0xb387bbc3) [/usr/lib/osp/libosp-uifw.so] + 0x49ebc3
 6: Tizen::Ui::_Control::CallOnAttachedToMainTree(Tizen::Ui::_Control&) + 0xb2 (0xb36880af) [/usr/lib/osp/libosp-uifw.so] + 0x2ab0af
 7: Tizen::Ui::_Control::EndAttaching(Tizen::Ui::_Control&) + 0xfc (0xb368b969) [/usr/lib/osp/libosp-uifw.so] + 0x2ae969
 8: Tizen::Ui::_Control::AttachChild(Tizen::Ui::_Control&) + 0x72 (0xb368e4ef) [/usr/lib/osp/libosp-uifw.so] + 0x2b14ef
 9: Tizen::Ui::_ContainerImpl::AddChild(Tizen::Ui::_ControlImpl*, bool) + 0xac (0xb36ae051) [/usr/lib/osp/libosp-uifw.so] + 0x2d1051
10: Tizen::Ui::Container::AddControl(Tizen::Ui::Control*) + 0x26 (0xb36827b7) [/usr/lib/osp/libosp-uifw.so] + 0x2a57b7
11: Tizen::Ui::Container::AddControl(Tizen::Ui::Control const&) + 0x6 (0xb3682843) [/usr/lib/osp/libosp-uifw.so] + 0x2a5843
End of Call Stack
