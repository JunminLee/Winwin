...
PID: 8787
Date: 2014-08-15 02:31:00(GMT+0900)
...
Call Stack Count: 32
 ...
 1: JMChattControl::GetImageIndexByPoint(Tizen::Graphics::Point) + 0xa8 (0xb263dc98) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39c98
 2: JMChattControl::OnTouchPressed(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0xc8 (0xb263db80) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39b80
 3: non-virtual thunk to JMChattControl::OnTouchPressed(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0x4c (0xb263de14) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39e14
