...
PID: 16064
Date: 2014-08-15 02:32:25(GMT+0900)
...
Callstack Information (PID:16064)
Call Stack Count: 32
 0: Tizen::Graphics::Rectangle::Rectangle(Tizen::Graphics::Rectangle const&) + 0xf (0xb3a2249c) [/usr/lib/osp/libosp-uifw.so] + 0x62c49c
 1: JMChattControl::GetImageIndexByPoint(Tizen::Graphics::Point) + 0xa8 (0xb263dc60) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39c60
 2: JMChattControl::OnTouchPressed(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0x90 (0xb263db48) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39b48
 3: non-virtual thunk to JMChattControl::OnTouchPressed(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0x4c (0xb263dddc) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39ddc
