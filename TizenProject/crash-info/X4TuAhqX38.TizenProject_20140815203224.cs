...
PID: 27015
Date: 2014-08-15 20:32:24(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 27015, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00006987
r2   = 0x00000006, r3   = 0x00006987
r4   = 0x00000006, r5   = 0xb6bfbbe4
r6   = 0xb6bfb000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00000000
r10  = 0xb6a0c000, fp   = 0xbeebcfe0
ip   = 0xb6a0c4c0, sp   = 0xbeebc770
...
000dc000 008db000 rw-p [heap]
af9b7000 af9bc000 r-xp /usr/lib/libhaptic-module.so
...
Callstack Information (PID:27015)
Call Stack Count: 36
 ...
 4: Tizen::Graphics::TextElement::GetText() const + 0x2c (0xb3a1e55d) [/usr/lib/osp/libosp-uifw.so] + 0x62855d
 5: PartnerItem::OnDraw(Tizen::Graphics::Canvas&, Tizen::Graphics::Rectangle const&, Tizen::Ui::Controls::ListItemDrawingStatus) + 0x538 (0xb263dfc0) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x3bfc0
End of Call Stack
