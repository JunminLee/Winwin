...
PID: 6686
Date: 2014-08-15 01:50:35(GMT+0900)
...
000dc000 00aba000 rw-p [heap]
af9c8000 af9ca000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af9d2000 af9e3000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
af9ec000 af9f1000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
af9f9000 af9fe000 r-xp /usr/lib/libhaptic-module.so
...
b2604000 b266e000 r-xp /opt/usr/apps/X4TuAhqX38/bin/TizenProject.exe
...
Callstack Information (PID:6686)
Call Stack Count: 32
 0: Tizen::Graphics::Rectangle::Rectangle(Tizen::Graphics::Rectangle const&) + 0xf (0xb3a2249c) [/usr/lib/osp/libosp-uifw.so] + 0x62c49c
 1: JMChattControl::GetImageIndexByPoint(Tizen::Graphics::Point) + 0xa8 (0xb263ddbc) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39dbc
 2: JMChattControl::OnTouchPressed(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0xf8 (0xb263dca4) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39ca4
 3: non-virtual thunk to JMChattControl::OnTouchPressed(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0x4c (0xb263df38) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39f38
