...
PID: 28502
Date: 2014-08-15 19:52:10(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 28502, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00006f56
r2   = 0x00000006, r3   = 0x00006f56
r4   = 0x00000006, r5   = 0xb6bf4be4
r6   = 0xb6bf4000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00678758
r10  = 0xb6a05000, fp   = 0x006af6d0
ip   = 0xb6a054c0, sp   = 0xbeda64a0
...
000dc000 0075d000 rw-p [heap]
acd0f000 acd14000 r-xp /usr/lib/libhaptic-module.so
ad544000 ad546000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af458000 af469000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b0807000 b080c000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b0bc7000 b0bca000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b2412000 b245d000 r-xp /usr/lib/libGLESv1_CM.so.1.1
b2466000 b248e000 r-xp /usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so
b24b6000 b24ca000 r-xp /usr/lib/libnetwork.so.0.0.0
b24d3000 b24e7000 r-xp /usr/lib/libwifi-direct.so.0.0
b24ef000 b24f7000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b24f8000 b2501000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b2509000 b25ce000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b25dc000 b25f9000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b2602000 b260c000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b2614000 b2667000 r-xp /opt/usr/apps/ZPYDNnmVpf/bin/TizenProject.exe
...
Callstack Information (PID:28502)
Call Stack Count: 5
 0: gsignal + 0x3c (0xb6af7760) [/lib/libc.so.6] + 0x2a760
 1: abort + 0x1ac (0xb6afb55c) [/lib/libc.so.6] + 0x2e55c
 2: __gnu_cxx::__verbose_terminate_handler() + 0xda (0xb4c451e7) [/usr/lib/libstdc++.so.6] + 0x881e7
 3: __cxxabiv1::__terminate(void (*)()) + 0x4 (0xb4c43d99) [/usr/lib/libstdc++.so.6] + 0x86d99
 4: std::terminate() + 0x10 (0xb4c43db5) [/usr/lib/libstdc++.so.6] + 0x86db5
End of Call Stack
