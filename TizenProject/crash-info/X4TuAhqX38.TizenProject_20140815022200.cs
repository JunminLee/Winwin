...
PID: 4649
Date: 2014-08-15 02:22:00(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 4649, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00001229
r2   = 0x00000006, r3   = 0x00001229
r4   = 0x00000006, r5   = 0xb6bfbbe4
r6   = 0xb6bfb000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x000d8268
...
Callstack Information (PID:4649)
Call Stack Count: 47
 ...
 5: Chatting::RequestHttpPost() + 0xd0 (0xb261a2e0) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x162e0
 6: Chatting::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x14c (0xb261af18) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x16f18
 7: non-virtual thunk to Chatting::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb261be20) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x17e20
End of Call Stack
