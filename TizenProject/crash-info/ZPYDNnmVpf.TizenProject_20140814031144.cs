...
PID: 4645
Date: 2014-08-14 03:11:44(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 4645, uid 5000)

Register Information
r0   = 0xbedb59a4, r1   = 0x000030e4
r2   = 0x00000000, r3   = 0xb4424940
r4   = 0xbedb59a4, r5   = 0x00000000
r6   = 0x003e6040, r7   = 0x00396a48
r8   = 0xb4424940, r9   = 0x000d0b10
r10  = 0xb4424940, fp   = 0xbedb5cb8
ip   = 0xb442777c, sp   = 0xbedb5980
lr   = 0xb4238d7f, pc   = 0xb4238d86
cpsr = 0x48000030
...
00018000 000ec000 rw-p [heap]
000ec000 00db6000 rw-p [heap]
a8f71000 a8f73000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
ab93d000 ab942000 r-xp /usr/lib/libhaptic-module.so
ad7ec000 ad7fd000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b0113000 b0118000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b0bbb000 b0bbe000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b2406000 b2451000 r-xp /usr/lib/libGLESv1_CM.so.1.1
b245a000 b2482000 r-xp /usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so
...
b25f6000 b2600000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b2608000 b2655000 r-xp /opt/usr/apps/ZPYDNnmVpf/bin/TizenProject.exe
...
Callstack Information (PID:4645)
Call Stack Count: 42
 0: Tizen::Base::String::String(Tizen::Base::String const&) + 0x19 (0xb4238d86) [/usr/lib/osp/libosp-appfw.so] + 0x130d86
 1: Tizen::Base::String::operator=(Tizen::Base::String const&) + 0x12 (0xb423a0cf) [/usr/lib/osp/libosp-appfw.so] + 0x1320cf
 2: Editing::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x784 (0xb26247dc) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x1c7dc
 3: non-virtual thunk to Editing::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb26264b8) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x1e4b8
End of Call Stack
