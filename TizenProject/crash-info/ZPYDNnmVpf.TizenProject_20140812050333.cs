...
PID: 5282
Date: 2014-08-12 05:03:33(GMT+0900)
...
r2   = 0x83fd9a00, r3   = 0x00000013
r4   = 0x000006d0, r5   = 0x00871058
r6   = 0xab99d8f0, r7   = 0xbedb6608
r8   = 0xab99e608, r9   = 0xab99d928
r10  = 0xbedb640c, fp   = 0xbedb63b8
ip   = 0x000033a8, sp   = 0xbedb5f70
lr   = 0xb6b8d790, pc   = 0xb262c29c
cpsr = 0x68000010
...
Call Stack Count: 26
 0: Editing::OnKeyReleased(Tizen::Ui::Control const&, Tizen::Ui::KeyCode) + 0x1ae4 (0xb262c29c) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x1d29c
 1: non-virtual thunk to Editing::OnKeyReleased(Tizen::Ui::Control const&, Tizen::Ui::KeyCode) + 0x3c (0xb262c7a8) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x1d7a8
