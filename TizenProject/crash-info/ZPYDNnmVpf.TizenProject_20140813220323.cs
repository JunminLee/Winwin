...
PID: 13531
Date: 2014-08-13 22:03:23(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 13531, uid 5000)

Register Information
r0   = 0x00000002, r1   = 0xbedb5410
r2   = 0x00000000, r3   = 0x00000000
r4   = 0xbedb5410, r5   = 0xb3d3fd70
r6   = 0x00870dc0, r7   = 0x00000002
r8   = 0x00000000, r9   = 0xbedb5754
r10  = 0x00000001, fp   = 0xbedb5628
ip   = 0xb3d41da0, sp   = 0xbedb50f8
...
000dc000 00dd1000 rw-p [heap]
ae6e1000 ae6e6000 r-xp /usr/lib/libhaptic-module.so
b0bb1000 b0bb4000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b23fc000 b2447000 r-xp /usr/lib/libGLESv1_CM.so.1.1
b2450000 b2478000 r-xp /usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so
b24a0000 b24b4000 r-xp /usr/lib/libnetwork.so.0.0.0
b24bd000 b24d1000 r-xp /usr/lib/libwifi-direct.so.0.0
b24d9000 b24e1000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b24e2000 b24eb000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b24f3000 b25b8000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b25c6000 b25e3000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b25ec000 b25f6000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b25fe000 b2655000 r-xp /opt/usr/apps/ZPYDNnmVpf/bin/TizenProject.exe
...
Callstack Information (PID:13531)
Call Stack Count: 55
 ...
 2: Tizen::Ui::Controls::Panel::Construct(Tizen::Graphics::Rectangle const&, Tizen::Ui::Controls::GroupStyle) + 0x10 (0xb3756699) [/usr/lib/osp/libosp-uifw.so] + 0x379699
 3: ChattingForm::OnInitializing() + 0x9e0 (0xb26128b0) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x148b0
