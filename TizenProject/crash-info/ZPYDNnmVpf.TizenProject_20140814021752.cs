...
PID: 28650
Date: 2014-08-14 02:17:52(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 28650, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x0074666c
r2   = 0x00000000, r3   = 0xb4424940
r4   = 0x00913610, r5   = 0x0074666c
r6   = 0x00913610, r7   = 0xb3d3fd70
r8   = 0xb3d3fd70, r9   = 0xbedb5770
r10  = 0x00000000, fp   = 0xbedb55c0
ip   = 0xb37475d5, sp   = 0xbedb53e8
lr   = 0xb37475dd, pc   = 0xb3873054
cpsr = 0x68000030
...
Callstack Information (PID:28650)
Call Stack Count: 45
 0: (0xb3873054) [/usr/lib/osp/libosp-uifw.so] + 0x496054
 1: Tizen::Ui::Controls::EditField::AddTextEventListener(Tizen::Ui::ITextEventListener&) + 0x8 (0xb37475dd) [/usr/lib/osp/libosp-uifw.so] + 0x36a5dd
 2: Chatting::OnInitializing() + 0x104 (0xb260c7f8) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x117f8
 3: Tizen::Ui::_ControlImpl::OnAttachedToMainTree() + 0x22 (0xb36a11a3) [/usr/lib/osp/libosp-uifw.so] + 0x2c41a3
 4: Tizen::Ui::Controls::_FormImpl::OnAttachedToMainTree() + 0x2e (0xb387bbc3) [/usr/lib/osp/libosp-uifw.so] + 0x49ebc3
 5: Tizen::Ui::_Control::CallOnAttachedToMainTree(Tizen::Ui::_Control&) + 0xb2 (0xb36880af) [/usr/lib/osp/libosp-uifw.so] + 0x2ab0af
 6: Tizen::Ui::_Control::EndAttaching(Tizen::Ui::_Control&) + 0xfc (0xb368b969) [/usr/lib/osp/libosp-uifw.so] + 0x2ae969
 7: Tizen::Ui::_Control::AttachChild(Tizen::Ui::_Control&) + 0x72 (0xb368e4ef) [/usr/lib/osp/libosp-uifw.so] + 0x2b14ef
 8: Tizen::Ui::_ContainerImpl::AddChild(Tizen::Ui::_ControlImpl*, bool) + 0xac (0xb36ae051) [/usr/lib/osp/libosp-uifw.so] + 0x2d1051
 9: Tizen::Ui::Container::AddControl(Tizen::Ui::Control*) + 0x26 (0xb36827b7) [/usr/lib/osp/libosp-uifw.so] + 0x2a57b7
10: Tizen::Ui::Container::AddControl(Tizen::Ui::Control const&) + 0x6 (0xb3682843) [/usr/lib/osp/libosp-uifw.so] + 0x2a5843
End of Call Stack
