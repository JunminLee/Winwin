...
PID: 29360
Date: 2014-08-15 02:14:14(GMT+0900)
...
Callstack Information (PID:29360)
Call Stack Count: 32
 0: Tizen::Graphics::Rectangle::Rectangle(Tizen::Graphics::Rectangle const&) + 0xf (0xb3a2249c) [/usr/lib/osp/libosp-uifw.so] + 0x62c49c
 1: JMChattControl::GetImageIndexByPoint(Tizen::Graphics::Point) + 0xa8 (0xb263dc8c) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39c8c
 2: JMChattControl::OnTouchPressed(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0xf8 (0xb263db74) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39b74
 3: non-virtual thunk to JMChattControl::OnTouchPressed(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0x4c (0xb263de08) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39e08
