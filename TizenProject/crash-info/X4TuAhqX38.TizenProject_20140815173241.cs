...
PID: 17280
Date: 2014-08-15 17:32:41(GMT+0900)
...
r4   = 0x0033e2ee, r5   = 0xffe4e4e4
r6   = 0xbeebcf98, r7   = 0xbeebcfb0
r8   = 0x000002d0, r9   = 0x00000000
r10  = 0xb263e8b4, fp   = 0xbeebcfe0
ip   = 0xb6a0cb98, sp   = 0xbeebcdb0
lr   = 0xb6f1caac, pc   = 0xb3a1aa7c
cpsr = 0x48000030
...
000dc000 00bae000 rw-p [heap]
ae772000 ae777000 r-xp /usr/lib/libhaptic-module.so
...
Call Stack Count: 32
 0: Tizen::Graphics::Canvas::FillRectangle(Tizen::Graphics::Color const&, Tizen::Graphics::Rectangle const&) + 0xf (0xb3a1aa7c) [/usr/lib/osp/libosp-uifw.so] + 0x624a7c
 1: PartnerItem::OnDraw(Tizen::Graphics::Canvas&, Tizen::Graphics::Rectangle const&, Tizen::Ui::Controls::ListItemDrawingStatus) + 0xcc (0xb263e980) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x3b980
End of Call Stack
