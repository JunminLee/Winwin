...
PID: 5355
Date: 2014-08-12 05:04:55(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 5355, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x0000004b
r2   = 0xb4417330, r3   = 0x83fd9a00
r4   = 0xfffecb76, r5   = 0xab9ba928
r6   = 0xab95c2c0, r7   = 0xbedb6608
r8   = 0xab9639f8, r9   = 0xab95c3d0
r10  = 0xbedb640c, fp   = 0xbedb63b8
ip   = 0xb2660254, sp   = 0xbedb5f70
lr   = 0xb262c000, pc   = 0xb4238530
cpsr = 0x28000030
...
af2ee000 af2ff000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b011c000 b0121000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b0129000 b012b000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b0133000 b0138000 r-xp /usr/lib/libhaptic-module.so
...
Callstack Information (PID:5355)
Call Stack Count: 27
 0: Tizen::Base::String::GetCapacity() const + 0x3 (0xb4238530) [/usr/lib/osp/libosp-appfw.so] + 0x130530
 1: Editing::OnKeyReleased(Tizen::Ui::Control const&, Tizen::Ui::KeyCode) + 0x1848 (0xb262c000) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x1d000
 2: non-virtual thunk to Editing::OnKeyReleased(Tizen::Ui::Control const&, Tizen::Ui::KeyCode) + 0x3c (0xb262c7a8) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x1d7a8
 3: Tizen::Ui::_ControlImpl::_PropagatedKeyEventListener::OnKeyReleased(Tizen::Ui::_Control const&, Tizen::Ui::_KeyInfo const&) + 0x150 (0xb36ac295) [/usr/lib/osp/libosp-uifw.so] + 0x2cf295
End of Call Stack
