...
PID: 32351
Date: 2014-08-15 17:18:30(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 32351, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000000
r2   = 0x004fef48, r3   = 0xb3d58d70
r4   = 0x009199c8, r5   = 0x00000000
r6   = 0x009199c8, r7   = 0xb3d58d70
r8   = 0xa00009cb, r9   = 0xbeebc754
r10  = 0x00000001, fp   = 0xbeebc628
ip   = 0xb267941c, sp   = 0xbeebbbb0
lr   = 0xb3766f09, pc   = 0xb389981c
cpsr = 0x48000030
...
000dc000 00afd000 rw-p [heap]
af9b8000 af9bd000 r-xp /usr/lib/libhaptic-module.so
b1c7f000 b1cca000 r-xp /usr/lib/libGLESv1_CM.so.1.1
b1cd3000 b1cdd000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b1ce5000 b1d0d000 r-xp /usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so
b1d35000 b1d41000 r-xp /usr/lib/libtzsvc.so.0.0.1
b1d4e000 b1d74000 r-xp /usr/lib/libzmq.so.3.0.0
b1d7e000 b1d87000 r-xp /usr/lib/libpims-ipc.so.0.0.30
b1d8f000 b1d91000 r-xp /usr/lib/libemail-network.so.1.1.0
b1d99000 b1db2000 r-xp /usr/lib/libaccounts-svc.so.0.2.66
b1dba000 b1e64000 r-xp /usr/lib/libuw-imap-toolkit.so.0.0.0
b1e72000 b1e76000 r-xp /usr/lib/libss-client.so.1.0.0
b1e7e000 b1e80000 r-xp /usr/lib/libcamsrcjpegenc.so.0.0.0
b1e88000 b1e91000 r-xp /usr/lib/libmsg_vobject.so
b1e9a000 b1ea4000 r-xp /usr/lib/libdrm-client.so.0.0.1
b1eac000 b1f1e000 r-xp /usr/lib/libcontacts-service2.so.0.9.114.7
b1f3d000 b1f56000 r-xp /usr/lib/libmsg_plugin_manager.so
b1f5f000 b1f98000 r-xp /usr/lib/libmsg_framework_handler.so
b1fa1000 b1fd5000 r-xp /usr/lib/libmsg_transaction_proxy.so
b1fde000 b201e000 r-xp /usr/lib/libmsg_utils.so
b201f000 b202e000 r-xp /usr/lib/libemail-common-use.so.1.1.0
b2037000 b20b2000 r-xp /usr/lib/libemail-core.so.1.1.0
b20c2000 b210b000 r-xp /usr/lib/libemail-storage.so.1.1.0
b2114000 b2121000 r-xp /usr/lib/libemail-ipc.so.1.1.0
b2129000 b212f000 r-xp /usr/lib/libshortcut.so.0.0.1
b2138000 b213e000 r-xp /usr/lib/libbadge.so.0.0.1
b2146000 b214c000 r-xp /usr/lib/libcapi-appfw-app-manager.so.0.1.0
b2154000 b2166000 r-xp /usr/lib/libmmfile_utils.so.0.0.0
b216e000 b2173000 r-xp /usr/lib/libmmffile.so.0.0.0
b217b000 b21df000 r-xp /usr/lib/libmmfcamcorder.so.0.0.0
b21ec000 b2200000 r-xp /usr/lib/libnetwork.so.0.0.0
b2209000 b2211000 r-xp /usr/lib/libpush.so.0.2.12
b2219000 b2234000 r-xp /usr/lib/libmsg_mapi.so.0.1.0
b223d000 b2255000 r-xp /usr/lib/libemail-api.so.1.1.0
b225d000 b227b000 r-xp /usr/lib/osp/libosp-shell-core.so.1.2.2.1
b2284000 b229e000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b22a8000 b22ad000 r-xp /usr/lib/libcapi-media-metadata-extractor.so
b22b5000 b22ba000 r-xp /usr/lib/libcapi-media-recorder.so.0.1.3
b22c2000 b22cd000 r-xp /usr/lib/libcapi-media-camera.so.0.1.4
b22d5000 b22d8000 r-xp /usr/lib/libcapi-media-sound-manager.so.0.1.1
b22e0000 b22ee000 r-xp /usr/lib/libcapi-media-player.so.0.1.1
b22f6000 b2317000 r-xp /usr/lib/libopencore-amrnb.so.0.0.2
b2320000 b2324000 r-xp /usr/lib/libogg.so.0.7.1
b232c000 b234e000 r-xp /usr/lib/libvorbis.so.0.4.3
b2356000 b235a000 r-xp /usr/lib/libcapi-media-audio-io.so.0.2.0
b2362000 b2376000 r-xp /usr/lib/libwifi-direct.so.0.0
b237e000 b2386000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b2387000 b2390000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b2398000 b23e5000 r-xp /usr/lib/osp/libosp-messaging.so.1.2.2.0
b23ef000 b24e5000 r-xp /usr/lib/osp/libosp-media.so.1.2.2.0
b24f8000 b25bd000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b25cb000 b25e8000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b25f1000 b25f4000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b2603000 b266d000 r-xp /opt/usr/apps/X4TuAhqX38/bin/TizenProject.exe
...
Callstack Information (PID:32351)
Call Stack Count: 54
 0: (0xb389981c) [/usr/lib/osp/libosp-uifw.so] + 0x4a381c
 1: Tizen::Ui::Controls::Header::SetStyle(Tizen::Ui::Controls::HeaderStyle) + 0x8 (0xb3766f09) [/usr/lib/osp/libosp-uifw.so] + 0x370f09
 2: PartnerListForm::OnInitializing() + 0x9a0 (0xb2640cf0) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x3dcf0
 3: Tizen::Ui::_ControlImpl::OnAttachedToMainTree() + 0x22 (0xb36ba1a3) [/usr/lib/osp/libosp-uifw.so] + 0x2c41a3
 4: Tizen::Ui::Controls::_FormImpl::OnAttachedToMainTree() + 0x2e (0xb3894bc3) [/usr/lib/osp/libosp-uifw.so] + 0x49ebc3
 5: Tizen::Ui::_Control::CallOnAttachedToMainTree(Tizen::Ui::_Control&) + 0xb2 (0xb36a10af) [/usr/lib/osp/libosp-uifw.so] + 0x2ab0af
 6: Tizen::Ui::_Control::EndAttaching(Tizen::Ui::_Control&) + 0xfc (0xb36a4969) [/usr/lib/osp/libosp-uifw.so] + 0x2ae969
 7: Tizen::Ui::_Control::AttachChild(Tizen::Ui::_Control&) + 0x72 (0xb36a74ef) [/usr/lib/osp/libosp-uifw.so] + 0x2b14ef
 8: Tizen::Ui::_ContainerImpl::AddChild(Tizen::Ui::_ControlImpl*, bool) + 0xac (0xb36c7051) [/usr/lib/osp/libosp-uifw.so] + 0x2d1051
 9: Tizen::Ui::Container::AddControl(Tizen::Ui::Control*) + 0x26 (0xb369b7b7) [/usr/lib/osp/libosp-uifw.so] + 0x2a57b7
10: Tizen::Ui::Container::AddControl(Tizen::Ui::Control const&) + 0x6 (0xb369b843) [/usr/lib/osp/libosp-uifw.so] + 0x2a5843
End of Call Stack
