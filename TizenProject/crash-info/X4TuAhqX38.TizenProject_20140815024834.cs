...
PID: 2680
Date: 2014-08-15 02:48:34(GMT+0900)
...
000dc000 00dc4000 rw-p [heap]
a7779000 a777b000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
aa2dc000 aa2e1000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
aeb77000 aeb88000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b0080000 b0085000 r-xp /usr/lib/libhaptic-module.so
...
Call Stack Count: 32
 ...
 1: JMChattControl::GetImageIndexByPoint(Tizen::Graphics::Point) + 0xa8 (0xb263dbac) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39bac
 2: JMChattControl::OnTouchPressed(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0xf8 (0xb263da94) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39a94
 3: non-virtual thunk to JMChattControl::OnTouchPressed(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0x4c (0xb263dd28) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39d28
