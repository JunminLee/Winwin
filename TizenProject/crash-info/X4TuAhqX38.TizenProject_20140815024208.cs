...
PID: 13172
Date: 2014-08-15 02:42:08(GMT+0900)
...
Callstack Information (PID:13172)
Call Stack Count: 32
 0: Tizen::Graphics::Rectangle::Rectangle(Tizen::Graphics::Rectangle const&) + 0xf (0xb3a2249c) [/usr/lib/osp/libosp-uifw.so] + 0x62c49c
 1: JMChattControl::GetImageIndexByPoint(Tizen::Graphics::Point) + 0xa8 (0xb263dca4) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39ca4
 2: JMChattControl::OnTouchPressed(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0xf8 (0xb263db8c) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39b8c
 3: non-virtual thunk to JMChattControl::OnTouchPressed(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0x4c (0xb263de20) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39e20
