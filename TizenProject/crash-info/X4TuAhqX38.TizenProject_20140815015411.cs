...
PID: 14014
Date: 2014-08-15 01:54:11(GMT+0900)
...
000dc000 00a32000 rw-p [heap]
aeb66000 aeb77000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
af9a2000 af9a4000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af9ac000 af9b1000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
...
Callstack Information (PID:14014)
Call Stack Count: 32
 0: Tizen::Graphics::Rectangle::Rectangle(Tizen::Graphics::Rectangle const&) + 0xf (0xb3a2249c) [/usr/lib/osp/libosp-uifw.so] + 0x62c49c
 1: JMChattControl::GetImageIndexByPoint(Tizen::Graphics::Point) + 0xa8 (0xb263dd9c) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39d9c
 2: JMChattControl::OnTouchPressed(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0xf8 (0xb263dc84) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39c84
 3: non-virtual thunk to JMChattControl::OnTouchPressed(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0x4c (0xb263df18) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x39f18
