...
PID: 21681
Date: 2014-08-12 04:30:19(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 21681, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000000
r2   = 0x83fd9a00, r3   = 0x0000001d
r4   = 0x000006d0, r5   = 0x008651d0
r6   = 0x0086cd18, r7   = 0xbedb6608
r8   = 0x0086b880, r9   = 0x0086cd50
r10  = 0xbedb640c, fp   = 0xbedb63b8
ip   = 0x000033a8, sp   = 0xbedb5f70
lr   = 0xb6b8d790, pc   = 0xb262ad04
cpsr = 0x68000010
...
000dc000 00b2b000 rw-p [heap]
a9a8b000 a9a8d000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
af33f000 af350000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b0126000 b012b000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
...
b260f000 b2655000 r-xp /opt/usr/apps/ZPYDNnmVpf/bin/TizenProject.exe
...
Callstack Information (PID:21681)
Call Stack Count: 26
 0: Editing::OnKeyReleased(Tizen::Ui::Control const&, Tizen::Ui::KeyCode) + 0x1ae4 (0xb262ad04) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x1bd04
