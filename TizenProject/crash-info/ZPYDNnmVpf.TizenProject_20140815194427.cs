...
PID: 21698
Date: 2014-08-15 19:44:27(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 21698, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000000
r2   = 0x00000000, r3   = 0xb36ba065
r4   = 0x00945b20, r5   = 0x00010000
r6   = 0x00775098, r7   = 0x00775098
r8   = 0xbeda5efc, r9   = 0xbeda61e0
r10  = 0xb3d51d70, fp   = 0x00006a00
ip   = 0xb3d53a40, sp   = 0xbeda5cb0
lr   = 0xb37052d5, pc   = 0xb36bcb5c
cpsr = 0x88000030
...
000dc000 00d40000 rw-p [heap]
b0628000 b0639000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b0642000 b0647000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
b06d1000 b06d6000 r-xp /usr/lib/libhaptic-module.so
b06de000 b06e0000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b0bc8000 b0bcb000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b2413000 b245e000 r-xp /usr/lib/libGLESv1_CM.so.1.1
b2467000 b248f000 r-xp /usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so
b24b7000 b24cb000 r-xp /usr/lib/libnetwork.so.0.0.0
b24d4000 b24e8000 r-xp /usr/lib/libwifi-direct.so.0.0
b24f0000 b24f8000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b24f9000 b2502000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b250a000 b25cf000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b25dd000 b25fa000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b2603000 b260d000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b2615000 b2668000 r-xp /opt/usr/apps/ZPYDNnmVpf/bin/TizenProject.exe
...
b40e7000 b40e9000 r-xp /opt/usr/apps/ZPYDNnmVpf/bin/TizenProject
...
bed87000 beda8000 rwxp [stack]
End of Maps Information

Callstack Information (PID:21698)
Call Stack Count: 28
 0: Tizen::Ui::_ControlImpl::CoreTouchEvent::ProcessListener(Tizen::Ui::_TouchInfo const&) + 0x583 (0xb36bcb5c) [/usr/lib/osp/libosp-uifw.so] + 0x2cdb5c
 1: Tizen::Ui::_ControlImpl::CallOnTouchPressed(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0xac (0xb36b58dd) [/usr/lib/osp/libosp-uifw.so] + 0x2c68dd
 2: Tizen::Ui::_ControlImpl::_PropagatedTouchEventListener::OnTouchPressed(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0x200 (0xb36bd279) [/usr/lib/osp/libosp-uifw.so] + 0x2ce279
 3: Tizen::Ui::_UiTouchEvent::FireListener(Tizen::Ui::_ITouchEventListener const*, Tizen::Ui::_Control const*, bool, bool&) + 0x2de (0xb372396b) [/usr/lib/osp/libosp-uifw.so] + 0x33496b
 4: Tizen::Ui::_UiTouchEvent::OnEventProcessing(Tizen::Ui::_Control const&, bool&) + 0x62 (0xb3723e43) [/usr/lib/osp/libosp-uifw.so] + 0x334e43
 5: Tizen::Ui::_UiEvent::ProcessEvent(Tizen::Ui::_Control const&, bool&) + 0x32 (0xb3717f53) [/usr/lib/osp/libosp-uifw.so] + 0x328f53
 6: Tizen::Ui::_UiEventManager::ProcessBubblingEvent(Tizen::Base::Collection::LinkedListT<Tizen::Base::_HandleT<Tizen::Ui::_Control> > const&, Tizen::Ui::_UiEvent const&, bool&) + 0x78 (0xb3718901) [/usr/lib/osp/libosp-uifw.so] + 0x329901
 7: Tizen::Ui::_UiEventManager::ProcessEvent(Tizen::Ui::_UiEvent const&, bool&) + 0x234 (0xb3718bd5) [/usr/lib/osp/libosp-uifw.so] + 0x329bd5
 8: Tizen::Ui::_UiEventManager::Fire(Tizen::Ui::_UiEvent const&) + 0x8c (0xb3718cb9) [/usr/lib/osp/libosp-uifw.so] + 0x329cb9
 9: Tizen::Ui::_UiEventManager::SendEvent(Tizen::Ui::_UiEvent const&) + 0x6 (0xb3718d4b) [/usr/lib/osp/libosp-uifw.so] + 0x329d4b
10: (0xb3707be7) [/usr/lib/osp/libosp-uifw.so] + 0x318be7
11: (0xb3709717) [/usr/lib/osp/libosp-uifw.so] + 0x31a717
12: (0xb3709f81) [/usr/lib/osp/libosp-uifw.so] + 0x31af81
13: _ecore_timer_expired_call + 0xc2 (0xb68b486f) [/usr/lib/libecore.so.1] + 0xd86f
14: _ecore_timer_expired_timers_call + 0xe (0xb68b497b) [/usr/lib/libecore.so.1] + 0xd97b
15: _ecore_main_loop_iterate_internal + 0x26 (0xb68b203b) [/usr/lib/libecore.so.1] + 0xb03b
16: ecore_main_loop_begin + 0x30 (0xb68b25cd) [/usr/lib/libecore.so.1] + 0xb5cd
17: elm_run + 0x6 (0xb697b19f) [/usr/lib/libelementary.so.1] + 0xa819f
18: appcore_efl_main + 0x2d4 (0xb6ee47d5) [/usr/lib/libappcore-efl.so.1] + 0x27d5
19: app_efl_main + 0xc6 (0xb3ebc07f) [/usr/lib/libcapi-appfw-application.so.0] + 0x807f
20: Tizen::App::_AppImpl::Execute(Tizen::App::_IAppImpl*) + 0xe6 (0xb42078b3) [/usr/lib/osp/libosp-appfw.so] + 0xed8b3
21: Tizen::App::UiApp::Execute(Tizen::App::UiApp* (*)(), Tizen::Base::Collection::IList const*) + 0x64 (0xb3a9a231) [/usr/lib/osp/libosp-uifw.so] + 0x6ab231
22: OspMain + 0x1ac (0xb2655388) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x40388
23: main + 0x194 (0xb40e7f21) [/opt/apps/ZPYDNnmVpf/bin/TizenProject] + 0xf21
...
26: __libc_start_main + 0x114 (0xb6ae26e8) [/lib/libc.so.6] + 0x156e8
