...
PID: 1605
Date: 2014-08-17 18:08:21(GMT+0900)
...
r0   = 0xb2714550, r1   = 0x00000000
r2   = 0x00000298, r3   = 0xb2714550
r4   = 0x000aa940, r5   = 0xbed2a2a8
r6   = 0x00000002, r7   = 0xbed2a080
r8   = 0xbed2a068, r9   = 0xb2714550
r10  = 0x000837f0, fp   = 0xbed2a224
ip   = 0x00000000, sp   = 0xbed2a040
lr   = 0xb6fac3ec, pc   = 0xb6fbd080
cpsr = 0x20000010
...
b2691000 b2708000 r-xp /opt/usr/apps/X4TuAhqX38/bin/TizenProject.exe
...
Callstack Information (PID:1605)
Call Stack Count: 7
 0: memset + 0x30 (0xb6fbd080) [/lib/ld-linux.so.3] + 0x17080
 1: _dl_map_object_from_fd + 0x4a4 (0xb6fac3ec) [/lib/ld-linux.so.3] + 0x63ec
 2: _dl_map_object + 0x1b0 (0xb6fae000) [/lib/ld-linux.so.3] + 0x8000
 3: dl_open_worker + 0x14c (0xb6fb895c) [/lib/ld-linux.so.3] + 0x1295c
 4: _dl_catch_error + 0x74 (0xb6fb4654) [/lib/ld-linux.so.3] + 0xe654
 5: _dl_open + 0xb8 (0xb6fb84d8) [/lib/ld-linux.so.3] + 0x124d8
 6: dlopen_doit + 0x78 (0xb6cf7a10) [/lib/libdl.so.2] + 0xa10
End of Call Stack
