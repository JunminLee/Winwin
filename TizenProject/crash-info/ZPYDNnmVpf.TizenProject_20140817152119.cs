...
PID: 5965
Date: 2014-08-17 15:21:19(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 5965, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000001
r2   = 0x000001a6, r3   = 0x00000006
r4   = 0xbed29ed4, r5   = 0x00466128
r6   = 0xb26cb6fc, r7   = 0x007784f8
r8   = 0xbed29f84, r9   = 0xbed2a1d0
r10  = 0xb3df3d70, fp   = 0xbed29cf0
ip   = 0xb2714458, sp   = 0xbed29ac8
lr   = 0xb26cace4, pc   = 0xb26cb0a8
cpsr = 0x28000010
...
ac966000 ac96b000 r-xp /usr/lib/libhaptic-module.so
ad596000 ad598000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
b0737000 b0748000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
b0751000 b0756000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
...
Call Stack Count: 30
 0: EditPanel::OnTouchReleased(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0x4f4 (0xb26cb0a8) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x260a8
 1: non-virtual thunk to EditPanel::OnTouchReleased(Tizen::Ui::Control const&, Tizen::Graphics::Point const&, Tizen::Ui::TouchEventInfo const&) + 0x4c (0xb26cb748) [/opt/apps/ZPYDNnmVpf/bin/TizenProject.exe] + 0x26748
 2: Tizen::Ui::_ControlImpl::CoreTouchEvent::ProcessListener(Tizen::Ui::_TouchInfo const&) + 0x224 (0xb375e7fd) [/usr/lib/osp/libosp-uifw.so] + 0x2cd7fd
 3: Tizen::Ui::_ControlImpl::CallOnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0x6e (0xb3757eab) [/usr/lib/osp/libosp-uifw.so] + 0x2c6eab
 4: Tizen::Ui::_ControlImpl::_PropagatedTouchEventListener::OnTouchReleased(Tizen::Ui::_Control const&, Tizen::Ui::_TouchInfo const&) + 0x200 (0xb375febd) [/usr/lib/osp/libosp-uifw.so] + 0x2ceebd
 5: Tizen::Ui::_UiTouchEvent::FireListener(Tizen::Ui::_ITouchEventListener const*, Tizen::Ui::_Control const*, bool, bool&) + 0x280 (0xb37c590d) [/usr/lib/osp/libosp-uifw.so] + 0x33490d
 6: Tizen::Ui::_UiTouchEvent::OnEventProcessing(Tizen::Ui::_Control const&, bool&) + 0x62 (0xb37c5e43) [/usr/lib/osp/libosp-uifw.so] + 0x334e43
 7: Tizen::Ui::_UiEvent::ProcessEvent(Tizen::Ui::_Control const&, bool&) + 0x32 (0xb37b9f53) [/usr/lib/osp/libosp-uifw.so] + 0x328f53
 8: Tizen::Ui::_UiEventManager::ProcessBubblingEvent(Tizen::Base::Collection::LinkedListT<Tizen::Base::_HandleT<Tizen::Ui::_Control> > const&, Tizen::Ui::_UiEvent const&, bool&) + 0x78 (0xb37ba901) [/usr/lib/osp/libosp-uifw.so] + 0x329901
 9: Tizen::Ui::_UiEventManager::ProcessEvent(Tizen::Ui::_UiEvent const&, bool&) + 0x234 (0xb37babd5) [/usr/lib/osp/libosp-uifw.so] + 0x329bd5
10: Tizen::Ui::_UiEventManager::Fire(Tizen::Ui::_UiEvent const&) + 0x8c (0xb37bacb9) [/usr/lib/osp/libosp-uifw.so] + 0x329cb9
11: Tizen::Ui::_UiEventManager::SendEvent(Tizen::Ui::_UiEvent const&) + 0x6 (0xb37bad4b) [/usr/lib/osp/libosp-uifw.so] + 0x329d4b
End of Call Stack
