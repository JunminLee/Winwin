...
PID: 16282
Date: 2014-08-17 22:35:27(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 16282, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00003f9a
r2   = 0x00000006, r3   = 0x00003f9a
r4   = 0x00000006, r5   = 0xb6c96be4
r6   = 0xb6c96000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x000d3fb0
r10  = 0xb6aa7000, fp   = 0xbed29c68
ip   = 0xb6aa74c0, sp   = 0xbed290c0
...
000dc000 00aa4000 rw-p [heap]
aa9e6000 aa9eb000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
aec40000 aec42000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
afa29000 afa3a000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
afa43000 afa48000 r-xp /usr/lib/libhaptic-module.so
b1d0a000 b1d55000 r-xp /usr/lib/libGLESv1_CM.so.1.1
b1d5e000 b1d68000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b1d70000 b1d98000 r-xp /usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so
b1dc0000 b1dcc000 r-xp /usr/lib/libtzsvc.so.0.0.1
b1dd9000 b1dff000 r-xp /usr/lib/libzmq.so.3.0.0
b1e09000 b1e12000 r-xp /usr/lib/libpims-ipc.so.0.0.30
b1e1a000 b1e1c000 r-xp /usr/lib/libemail-network.so.1.1.0
b1e24000 b1e3d000 r-xp /usr/lib/libaccounts-svc.so.0.2.66
b1e45000 b1eef000 r-xp /usr/lib/libuw-imap-toolkit.so.0.0.0
b1efd000 b1f01000 r-xp /usr/lib/libss-client.so.1.0.0
b1f09000 b1f0b000 r-xp /usr/lib/libcamsrcjpegenc.so.0.0.0
b1f13000 b1f1c000 r-xp /usr/lib/libmsg_vobject.so
b1f25000 b1f2f000 r-xp /usr/lib/libdrm-client.so.0.0.1
b1f37000 b1fa9000 r-xp /usr/lib/libcontacts-service2.so.0.9.114.7
b1fc8000 b1fe1000 r-xp /usr/lib/libmsg_plugin_manager.so
b1fea000 b2023000 r-xp /usr/lib/libmsg_framework_handler.so
b202c000 b2060000 r-xp /usr/lib/libmsg_transaction_proxy.so
b2069000 b20a9000 r-xp /usr/lib/libmsg_utils.so
b20aa000 b20b9000 r-xp /usr/lib/libemail-common-use.so.1.1.0
b20c2000 b213d000 r-xp /usr/lib/libemail-core.so.1.1.0
b214d000 b2196000 r-xp /usr/lib/libemail-storage.so.1.1.0
b219f000 b21ac000 r-xp /usr/lib/libemail-ipc.so.1.1.0
b21b4000 b21ba000 r-xp /usr/lib/libshortcut.so.0.0.1
b21c3000 b21c9000 r-xp /usr/lib/libbadge.so.0.0.1
b21d1000 b21d7000 r-xp /usr/lib/libcapi-appfw-app-manager.so.0.1.0
b21df000 b21f1000 r-xp /usr/lib/libmmfile_utils.so.0.0.0
b21f9000 b21fe000 r-xp /usr/lib/libmmffile.so.0.0.0
b2206000 b226a000 r-xp /usr/lib/libmmfcamcorder.so.0.0.0
b2277000 b228b000 r-xp /usr/lib/libnetwork.so.0.0.0
b2294000 b229c000 r-xp /usr/lib/libpush.so.0.2.12
b22a4000 b22bf000 r-xp /usr/lib/libmsg_mapi.so.0.1.0
b22c8000 b22e0000 r-xp /usr/lib/libemail-api.so.1.1.0
b22e8000 b2306000 r-xp /usr/lib/osp/libosp-shell-core.so.1.2.2.1
b230f000 b2329000 r-xp /usr/lib/osp/libosp-json.so.1.2.2.0
b2333000 b2338000 r-xp /usr/lib/libcapi-media-metadata-extractor.so
b2340000 b2345000 r-xp /usr/lib/libcapi-media-recorder.so.0.1.3
b234d000 b2358000 r-xp /usr/lib/libcapi-media-camera.so.0.1.4
b2360000 b2363000 r-xp /usr/lib/libcapi-media-sound-manager.so.0.1.1
b236b000 b2379000 r-xp /usr/lib/libcapi-media-player.so.0.1.1
b2381000 b23a2000 r-xp /usr/lib/libopencore-amrnb.so.0.0.2
b23ab000 b23af000 r-xp /usr/lib/libogg.so.0.7.1
b23b7000 b23d9000 r-xp /usr/lib/libvorbis.so.0.4.3
b23e1000 b23e5000 r-xp /usr/lib/libcapi-media-audio-io.so.0.2.0
b23ed000 b2401000 r-xp /usr/lib/libwifi-direct.so.0.0
b2409000 b2411000 r-xp /usr/lib/libcapi-network-tethering.so.0.1.0
b2412000 b241b000 r-xp /usr/lib/libcapi-network-connection.so.0.1.3_18
b2423000 b2470000 r-xp /usr/lib/osp/libosp-messaging.so.1.2.2.0
b247a000 b2570000 r-xp /usr/lib/osp/libosp-media.so.1.2.2.0
b2583000 b2648000 r-xp /usr/lib/osp/libosp-net.so.1.2.2.0
b2656000 b2673000 r-xp /usr/lib/osp/libosp-image.so.1.2.2.0
b267c000 b267f000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b268e000 b2707000 r-xp /opt/usr/apps/X4TuAhqX38/bin/TizenProject.exe
...
Callstack Information (PID:16282)
Call Stack Count: 46
 ...
 4: Tizen::Media::AudioRecorder::CreateAudioFile(Tizen::Base::String const&, bool) + 0x44 (0xb24f2fc5) [/usr/lib/osp/libosp-media.so.1] + 0x78fc5
 5: JMChattControl::OnActionPerformed(Tizen::Ui::Control const&, int) + 0xb1c (0xb26ca6b0) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x3c6b0
 6: non-virtual thunk to JMChattControl::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb26cacc0) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x3ccc0
End of Call Stack
