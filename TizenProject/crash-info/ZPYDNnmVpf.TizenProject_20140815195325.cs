...
PID: 2934
Date: 2014-08-15 19:53:25(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 2934, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000b76
r2   = 0x00000006, r3   = 0x00000b76
r4   = 0x00000006, r5   = 0xb6bf4be4
r6   = 0xb6bf4000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x00000002
r10  = 0xb6a05000, fp   = 0xbeda6330
ip   = 0xb6a054c0, sp   = 0xbeda5bf0
lr   = 0xb6afb55c, pc   = 0xb6af7760
cpsr = 0x28000010
...
Callstack Information (PID:2934)
Call Stack Count: 28
 0: gsignal + 0x3c (0xb6af7760) [/lib/libc.so.6] + 0x2a760
 1: abort + 0x1ac (0xb6afb55c) [/lib/libc.so.6] + 0x2e55c
 2: __libc_message + 0x2cc (0xb6b2b088) [/lib/libc.so.6] + 0x5e088
 3: malloc_printerr + 0xa8 (0xb6b34f60) [/lib/libc.so.6] + 0x67f60
 4: malloc_consolidate + 0x25c (0xb6b352bc) [/lib/libc.so.6] + 0x682bc
 5: _int_malloc + 0x7bc (0xb6b37950) [/lib/libc.so.6] + 0x6a950
 6: __libc_malloc + 0x7c (0xb6b39dd0) [/lib/libc.so.6] + 0x6cdd0
 7: evas_gl_common_context_rectangle_push + 0x428 (0xb2474f2d) [/usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so] + 0xdf2d
 8: evas_gl_common_rect_draw + 0x202 (0xb2477f6b) [/usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so] + 0x10f6b
 9: eng_rectangle_draw + 0x30 (0xb246e0c5) [/usr/lib/evas/modules/engines/gl_x11/linux-gnueabi-armv7l-1.7.99/module.so] + 0x70c5
10: evas_render_updates_internal + 0x1290 (0xb66fa249) [/usr/lib/libevas.so.1] + 0x5c249
11: evas_render_updates + 0x2c (0xb66fafb1) [/usr/lib/libevas.so.1] + 0x5cfb1
12: _ecore_evas_x_render + 0x6c (0xb6641469) [/usr/lib/libecore_evas.so.1] + 0x11469
13: _ecore_evas_idle_enter + 0x38 (0xb663de2d) [/usr/lib/libecore_evas.so.1] + 0xde2d
14: _ecore_idle_enterer_call + 0x48 (0xb68b0b85) [/usr/lib/libecore.so.1] + 0x9b85
15: _ecore_main_loop_iterate_internal + 0x216 (0xb68b222b) [/usr/lib/libecore.so.1] + 0xb22b
