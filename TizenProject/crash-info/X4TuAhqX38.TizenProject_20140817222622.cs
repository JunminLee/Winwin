...
PID: 14782
Date: 2014-08-17 22:26:22(GMT+0900)
...
Signal: 6
      (SIGABRT)
      si_code: -6
      signal sent by tkill (sent by pid 14782, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x000039be
r2   = 0x00000006, r3   = 0x000039be
r4   = 0x00000006, r5   = 0xb6c96be4
r6   = 0xb6c96000, r7   = 0x0000010c
r8   = 0x00000be4, r9   = 0x000d3ee8
r10  = 0xb6aa7000, fp   = 0xbed29c68
ip   = 0xb6aa74c0, sp   = 0xbed290c8
...
aa94c000 aa951000 r-xp /usr/lib/scim-1.0/1.4.0/Config/socket.so
acfa8000 acfad000 r-xp /usr/lib/libhaptic-module.so
aff3f000 aff50000 r-xp /usr/lib/scim-1.0/1.4.0/IMEngine/socket.so
affe4000 affe6000 r-xp /usr/lib/evas/modules/loaders/png/linux-gnueabi-armv7l-1.7.99/module.so
...
Callstack Information (PID:14782)
Call Stack Count: 46
 ...
 5: JMChattControl::OnActionPerformed(Tizen::Ui::Control const&, int) + 0xad8 (0xb26ca66c) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x3c66c
 6: non-virtual thunk to JMChattControl::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb26cac74) [/opt/apps/X4TuAhqX38/bin/TizenProject.exe] + 0x3cc74
End of Call Stack
