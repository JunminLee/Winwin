...
bool
SettingForm::CreateMainList(void)
{
...
void
SettingForm::OnListViewItemStateChanged(ListView& view, int index, int elementId, ListItemStatus status)
{
	SceneManager* pSceneManager = SceneManager::GetInstance();
	AppAssert(pSceneManager);
...
void
SettingForm::OnListViewItemSwept(ListView& listView, int index, SweepDirection direction)
{

}

void
SettingForm::OnListViewContextItemStateChanged(ListView& listView, int index, int elementId, ListContextItemStatus status)
{

}

int
SettingForm::GetItemCount(void)
{
	return ITEM_COUNT;
}

bool
SettingForm::DeleteItem(int index, ListItemBase* pItem, float itemWidth)
{
	delete pItem;
	pItem = null;
	return false;
