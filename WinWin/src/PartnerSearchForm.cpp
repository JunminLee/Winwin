...
#ifndef PartnerSearchForm_CPP_
#define PartnerSearchForm_CPP_
...
{
	AppLog("welcomePartnerSearchForm");
...
bool
PartnerSearchForm::CreateMainList(void)
{
...
void
PartnerSearchForm::OnListViewItemStateChanged(ListView& view, int index, int elementId, ListItemStatus status)
{
	SceneManager* pSceneManager = SceneManager::GetInstance();
	AppAssert(pSceneManager);
...
void
PartnerSearchForm::OnListViewItemSwept(ListView& listView, int index, SweepDirection direction)
{

}

void
PartnerSearchForm::OnListViewContextItemStateChanged(ListView& listView, int index, int elementId, ListContextItemStatus status)
{
...
bool
PartnerSearchForm::DeleteItem(int index, ListItemBase* pItem, float itemWidth)
{
	delete pItem;
	pItem = null;
	return false;
...
ListItemBase*
PartnerSearchForm::CreateItem(int index, float itemWidth)
{
