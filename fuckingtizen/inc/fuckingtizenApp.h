#ifndef _FUCKINGTIZEN_APP_H_
#define _FUCKINGTIZEN_APP_H_
...
//  The fuckingtizenApp class must inherit from the UiApp class,
//  which provides the basic features necessary to define a UI application.
 
class fuckingtizenApp
...
public:
	...
	fuckingtizenApp(void);
	virtual ~fuckingtizenApp(void);
